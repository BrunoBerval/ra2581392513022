...
export const projects: Project[] = [
  {
    id: 1,
    title: "Sistema Acadêmico para Controle de Horários (ABP 1)",
    ...
    tags: ["JavaScript", "Express", "PostgreSQL", "Docker", "Redis"],
    imageUrl: "/abp1.png",
  ...
  },
  {
    ...
    tags: ["React", "TypeScript", "Express", "PostgreSQL", "Docker", "Redis", "Tailwind"],
  ...
  },
  {
    ...
    description: "Sistema de comércio eletrônico desenvolvido em Python/Flask. Inclui gestão de produtos, carrinho de compras e integração com banco de dados relacional via SQLAlchemy.",
  ...
  {
    id: 6,
    title: "Comunidade de Programadores",
    description: "Rede social/Fórum focada em desenvolvedores. Possui sistema completo de autenticação, feed de postagens, upload de mídia e interações sociais em tempo real.",
    tags: ["Python", "Flask", "SQLAlchemy", "SQLite", "HTML/CSS"],
    imageUrl: "/flask-logo.png", // Adicionei .png, verifique sua imagem
  ...
  },
  {
    ...
    description: "Conjunto de atividades desenvolvidas durante o Bootcamp DIO/Bairesdev. Inclui detecção de objetos com YOLO 11 e redes neurais profundas (ResNet50, VGG16).",
