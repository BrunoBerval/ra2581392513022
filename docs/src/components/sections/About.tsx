        ...
        <div className="grid md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-7 space-y-6 text-slate-600 leading-relaxed text-lg">
            <p>
              ...
              aprender e aprimorar minhas habilidades. Durante minha jornada,
              tenho me dedicado a me aprimorar na área de engenharia de
              software e explorar ferramentas modernas que me ajudem a construir
              soluções mais sólidas e eficientes.
            </p>
            ...
            <p>
              ...
              , trabalhando no desenvolvimento de aplicações fullstack, tanto na
              criação de APIs RESTful quanto na construção de interfaces mais
              dinâmicas e agradáveis de usar.
            </p>
            No momento, estou voltado ao estudo de{" "}
            <strong>Desenvolvimento Web</strong> com foco em boas práticas para
            aplicações distribuídas. Tenho me aprofundado em ferramentas como{" "}
            <strong>Docker</strong> para padronização de ambientes,{" "}
            <strong>Redis</strong> para caching e filas, além de mecanismos de
            <strong> autenticação baseada em tokens (JWT)</strong> e controle de
            sessão. Meu objetivo é compreender melhor como estruturar sistemas
            mais seguros, rápidos e fáceis de manter.
          </div>
